...
### 2. 发布文档管理规则
版本发布相关文档统一管理：
- 发布说明 → `docs/releases/RELEASE_NOTES_v*.md`
- 发布清单 → `docs/releases/RELEASE_CHECKLIST_v*.md`
- 验证脚本 → `docs/releases/verify_release_v*.sh`
- 历史版本 → 保留在 `docs/releases/`
...
### 每次开发周期结束后
1. 整理测试产出物到 `docs/testing/`
2. 归档旧版本文档到 `docs/archive/`
3. 清理根目录临时文件
4. 更新本文档（如有结构变更）
