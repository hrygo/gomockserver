...
### 当前版本
- **最新版本**: v0.6.2 (Enterprise Foundation)
- **发布日期**: 2025-11-18
- **测试覆盖率**: 总体 94% (E2E测试)，核心模块 80%+
...
- **脚本维护**：核心脚本统一管理在 `tests/scripts/`，临时/废弃脚本归档至 `docs/archive/`
- **历史文档归档**：`docs/archive/`
...
### 4. 脚本管理规则 (v0.6.2+更新)
- 核心脚本统一管理在 `tests/scripts/` 目录
- 集成测试脚本放在 `tests/integration/` 目录
- 临时脚本归档至相应功能目录
...
### v0.6.2 (2025-11-18)
- ✅ 合并 `scripts/` 目录到 `tests/scripts/` 统一管理
...
| 覆盖率数据 | `tests/coverage/` | 项目根目录 |
| 测试数据 | `tests/data/` | 项目根目录 |
